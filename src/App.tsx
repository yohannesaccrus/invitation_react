...
function HomeContent({ recipient }: { recipient: string }) {
  return (
    <div className="flex min-h-screen flex-col-reverse lg:flex-row">
      ...
      {/* Sangjit Section */}
      <section className="relative flex min-h-[85vh] flex-1 flex-col items-center justify-center overflow-hidden p-8 lg:min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          <Link 
            to={`/sangjit?to=${encodeURIComponent(recipient)}`}
